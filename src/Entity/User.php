...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    private ?\DateTimeInterface $dateCreationUser = null;
     ...
     */
    #[ORM\OneToMany(targetEntity: Topic::class, mappedBy: 'id_user')]
    ...
    public function __construct()
    {
        ...
        $this->dateCreationUser = new \DateTime();
    }
    ...
    #[ORM\PrePersist]
    public function setDateCreationUser(\DateTimeInterface $dateCreationUser): static
    {
